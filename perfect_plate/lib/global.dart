class Global {
  ...
  //Map<DateTime, List<List<dynamic>>> calories;//Date and time it was eaten:[[calories eaten, calorie goal],["name of food", calories, grams of protein, grams of carbs, grams of fat]...]
